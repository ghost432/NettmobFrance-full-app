...
const Contact = () => {
    useDocumentTitle('Contact - NettmobFrance');
            ...
            <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 overflow-hidden bg-slate-900 text-white">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-xl text-slate-300 max-w-2xl mx-auto font-medium">
                        Une question ? Un projet ? Notre équipe est à votre écoute pour vous accompagner dans vos besoins en nettoyage et logistique.
                    </p>
                </div>
            </section>
