    ...
    return (
        <div className="p-4 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-black uppercase tracking-tight flex items-center gap-3">
                        ...
                        Demandes de Devis (<span className="text-primary">{devis.length}</span>)
                    </h1>
                    <p className="text-muted-foreground font-medium mt-2">Gérez les demandes de devis des entreprises clientes</p>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                {/* List */}
                <div className="lg:col-span-1 space-y-4 h-[calc(100vh-22rem)] overflow-y-auto pr-2 custom-scrollbar">
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <span className="text-[10px] uppercase tracking-wider font-black bg-muted px-2 py-1 rounded-md">
                                            {d.volume.split(' ')[0]} {/* Récupère juste "Moins", "De", "Plus" */}
                                        </span>
                                    </div>
                                </div>
                            );
